...
class VectorTests: XCTestCase {
    ...
    let v1 = Vector(polynomials: ["x": Polynomial(string: "2x + 1")])
    let v2 = Vector(polynomials: ["x": Polynomial(string: "2x + y")])
    let v3 = Vector(polynomials: ["x": Polynomial(string: "2x + 1"), "y": Polynomial(string: "2x + 1")])
    let v4 = Vector(polynomials: ["x": Polynomial(string: "2x + 1"), "y": Polynomial(string: "2x + y")])
    ...
    func testEquality() {
        XCTAssert(v1.isEqual(Vector(polynomials: ["x": Polynomial(string: "2x + 1")])), "equality")
    ...
    let p1 = Polynomial(string: "2x + 1")
    
    func testScalarAddition() {
        XCTAssertEqual(v1 + p, v1.scalarAddition(p), "overloading")
        XCTAssertEqual(v1 + p, Vector(polynomials: ["x": Polynomial(string: "4x + y + 1")]), "scalar addition")
        
        XCTAssertEqual(v4 + p, Vector(polynomials: ["x": Polynomial(string: "4x + y + 1"), "y": Polynomial(string: "4x + 2y")]), "scalar addition")
    }
    ...
    func testScalarMultiplication() {
        ...
        XCTAssertEqual(v1 * p, Vector(polynomials: ["x": Polynomial(string: "4x^2 + 2(x)(y) + 2x + y")]), "scalar multiplication")
        
        XCTAssertEqual(v4 * p, Vector(polynomials: ["x": Polynomial(string: "4x^2 + 2(x)(y) + 2x + y"), "y": p * p]), "scalar multiplication")
    }
    ...
    func testVectorAddition() {
        ...
        XCTAssertEqual(v1 + v2, Vector(polynomials: ["x": Polynomial(string: "4x + y + 1")]), "vector addition")
    }
    ...
    func testVectorSubtraction() {
        ...
        XCTAssertEqual(v2 - v1, Vector(polynomials: ["x": Polynomial(string: "y - 1")]), "vector subtraction")
    }
    ...
    func testVectorMultiplication() {
        ...
        XCTAssertEqual(v1 * v2, Vector(polynomials: ["x": Polynomial(string: "4x^2 + 2x + y + 2(x)(y)")]), "vector multiplication")
    }
